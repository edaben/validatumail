-- Script de Instalación de Base de Datos SaaS
...
CREATE INDEX idx_api_requests_month ON api_requests(client_id, YEAR(created_at), MONTH(created_at));
...
SELECT 
    ...
    c.monthly_usage,
    c.monthly_limit,
    ROUND((c.monthly_usage / c.monthly_limit) * 100, 2) as usage_percentage,
